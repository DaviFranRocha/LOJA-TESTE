...
const SLUG = 'cursos';
const LABEL: Record<string, string> = { ebooks: 'E-Books', cursos: 'Ferramentas', ferramentas: 'Ferramentas', jogos: 'Jogos' };
const EMOJI: Record<string, string> = { ebooks: '📚', cursos: '🔧', ferramentas: '🔧', jogos: '🎮' };
