          ...
          {done ? (
            <div className="text-center py-4">
              ...
              <h2 className="text-2xl font-black mb-2"
                style={{ fontFamily: "'Syne', sans-serif", color: 'var(--text-primary)' }}>Senha redefinida!</h2>
              <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Redirecionando para o login...</p>
            </div>
          ) : (
            <>
              <h2 className="text-2xl font-black mb-1"
                style={{ fontFamily: "'Syne', sans-serif", color: 'var(--text-primary)' }}>Nova senha</h2>
              <p className="text-sm mb-7" style={{ color: 'var(--text-muted)' }}>Digite sua nova senha abaixo.</p>
              {!token && (
                <p className="text-sm mb-4" style={{ color: '#f87171' }}>
                  Link inválido. <Link href="/auth/esqueci-senha" className="underline">Solicite um novo.</Link>
                </p>
              )}
                ...
                {([
                  ...
                  <div key={i}>
                    <label className="block text-xs font-bold uppercase tracking-widest mb-2"
                      style={{ color: 'var(--text-muted)', fontFamily: "'Syne', sans-serif" }}>{field.label}</label>
